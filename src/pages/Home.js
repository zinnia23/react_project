...
const Home = () => {
  ...
  >
    <p>
      It’s not just a statement; it's an invitation to join hands with a dynamic technology partner
      committed to shaping the future.
      <br />
      <br />
      Join us on this transformative journey and witness the power of collaboration, innovation, and
      expertise. Let your business evolve, adapt, and thrive with Hash Technologies - where
      transformation is not just a destination but a continuous and exciting journey.
      <br />
      <br />
